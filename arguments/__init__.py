...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # for sh version
        self.mlp_sh_lr_init = 0.008
        self.mlp_sh_lr_final = 0.00005
        self.mlp_sh_lr_delay_mult = 0.01
        self.mlp_sh_lr_max_steps = 30_000
        ...
        # for style transfer only special cases will use these
        self.style_mlp_color_lr_init = 0.008
        # self.style_mlp_color_lr_init = 1e-3
        
        # self.style_mlp_color_lr_final = 0.0025
        # self.style_mlp_color_lr_delay_mult = 0.01
        # self.style_mlp_color_lr_max_steps = 30_000

        # self.style_mlp_sh_lr_init = 0.008
        # self.style_mlp_sh_lr_final = 0.00005
        # self.style_mlp_sh_lr_delay_mult = 0.01
        # self.style_mlp_sh_lr_max_steps = 30_000
