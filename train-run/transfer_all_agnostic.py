...
def training(
    ...
    style_imgs = glob.glob(os.path.join(style_path, "*.jpg"))
    for style_img in tqdm(style_imgs):
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        # Pick a random style img
        style_img = np.random.choice(style_imgs)
        ...
        # print(feat["vgg_feature_map_0"].max())
        # print(feat["vgg_feature_map_0"].min())
        # print(feat["vgg_feature_map_1"].max())
        # print(feat["vgg_feature_map_1"].min())
        # print(feat["vgg_feature_map_2"].max())
        # print(feat["vgg_feature_map_2"].min())
        # print(feat["vgg_feature_map_3"].max())
        # print(feat["vgg_feature_map_3"].min())
        # print(model.image_cache[style_img]["vgg_feature_map_1"].max())
        ...
        # if iteration < 100:
        #     loss = rec_loss / (rec_loss.detach() + 1e-5)
        # else:
        #     loss = (
        #         rec_loss / (rec_loss.detach() + 1e-5)
        #         + adain_style_loss / (adain_style_loss.detach() + 1e-5)
        #         + adain_content_loss / (adain_content_loss.detach() + 1e-5)
        #         + content_loss / (content_loss.detach() + 1e-5)
        #     )
        if iteration < 100:
            loss = rec_loss
        else:
            loss = rec_loss + adain_style_loss + adain_content_loss 
        # loss =  rec_loss
        # import pdb
        # pdb.set_trace()
