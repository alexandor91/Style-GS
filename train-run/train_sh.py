...
def training(
    ...
    gaussians = GaussianSHModel(
        ...
        dataset.max_sh_degree,
    )
    scene = SceneSH(dataset, gaussians, ply_path=ply_path, shuffle=False)
...
def render_set(
    ...
    # model_path = model_path.replace("baseline_sh", "Ablation/baseline_sh") + "_deg3"
