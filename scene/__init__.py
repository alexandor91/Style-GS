...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], ply_path=None):
        ...
        elif os.path.exists(os.path.join(args.source_path, "meta.pkl")):
            scene_info = sceneLoadTypeCallbacks["SLAM"](
                args.source_path, args.eval, warmup_ply_path=ply_path
            )
...
class SceneSH:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianSHModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], ply_path=None):
        """b
        :param path: Path to colmap scene main folder.
        """
        self.model_path = args.model_path
